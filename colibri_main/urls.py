...
from .views import login_views, medical_history_views,register_views, search_patient_view, workspace_views,patient_managment_views,doctors_managment_views,appointments_view,register_new_patient_view,register_new_doctor_view,profile_doctor_views,notification_view,profile_patient_view,search_doctor_view,deleate_patients_views,toggle_patient_status
