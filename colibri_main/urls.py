...
from .views import login_views, medical_history_views,register_views, workspace_views,patient_managment_views,doctors_managment_views,appointments_view,register_new_patient_view,register_new_doctor_view
